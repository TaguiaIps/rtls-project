# mobile-self-location Specification

## Purpose

Provide real-time device self-location streaming to the mobile application with confidence-aware blue-dot visualization for calibration and administrative use.
