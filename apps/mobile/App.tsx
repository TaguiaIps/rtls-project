...
import { loadRecentSearches, saveRecentSearches } from "./src/storage";
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.panel}>
          ...
          <Text style={styles.helperText}>
            Dedicated mobile sign-in is still deferred. Paste a current access token to search the
            protected live-location APIs from this baseline.
          </Text>
            ...
            {results.map((asset) => (
              ...
              >
                ...
                <Text style={styles.resultMeta}>
                  Last seen {formatLastSeen(asset.observed_at)}
                </Text>
              </Pressable>
            ))}
          </View>
        ...
        <View style={styles.panel}>
          ...
          {recentSearches.map((entry) => (
            ...
            >
              ...
              <Text style={styles.resultMeta}>
                Opened {formatLastSeen(entry.savedAt)}
              </Text>
            </Pressable>
          ))}
        </View>
