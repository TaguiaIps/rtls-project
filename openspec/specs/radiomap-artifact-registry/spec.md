# radiomap-artifact-registry Specification

## Purpose
Manage durable radiomap and calibration artifact storage with versioning, lifecycle tracking, and high-performance retrieval for positioning estimators.
## Requirements
