# mobile-affective-feedback Specification

## Purpose
Provides standardized tactile and visual feedback for mobile-specific workflows to enhance operator satisfaction and data capture confidence.
