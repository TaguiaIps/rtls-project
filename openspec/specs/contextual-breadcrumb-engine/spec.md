# contextual-breadcrumb-engine Specification

## Purpose
Provides a dynamic breadcrumb trail that reflects the Site > Floor > Workspace hierarchy within the operational shell.
